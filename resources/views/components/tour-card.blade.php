...
<div class="max-w-sm mx-auto bg-white shadow-lg rounded-xl overflow-hidden transition-transform transform hover:bg-gray-100">
    ...
    <div class="p-4">
        ...
        <div class="mt-4">
            <a href="{{ route('tour.show', $tour->id) }}" target="_blank" class="bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 mr-ma2  border-green-800 hover:border-green-700 rounded-xl">
                Skatīt tūri
            </a>
        </div>
    </div>
