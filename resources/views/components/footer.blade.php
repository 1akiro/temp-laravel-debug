...
<footer class=" mt-8 bg-[#FAFAFA] text-[#2A2A2A] pt-8 pb-6 border-t border-[#D9D9D9]">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-ma6 text-sm mb-li2">
            ...
            <div>
                <h5 class="font-serif text-lg font-semibold mb-2">Saites</h5>
                <ul class="space-y-2">
            ...
            <div>
                 <h5 class="font-serif text-lg font-semibold mb-2">Seko mums</h5>
                <div class="flex justify-center space-x-6 mt-3">
                    ...
                    <a href="#" class="hover:text-[#D97B46]" aria-label="Instagram">
                        <svg class="h-5 w-5 fill-current text-[#2A2A2A]" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
